...
import Popoverdata from "@/components/popovers/popover-data-form2";
...
const formSchema = z.object({
  //forma 2
  "tabique-durlock-pb-pa": z.coerce
    .number()
    .min(0)
    .nullable()
    .transform((input: any) => {
  ...
  "balcon-con-porcelanato": z.coerce
    .number()
    .min(0)
    .nullable()
    .transform((input: any) => {
  ...
  "cantidad-encuentros-PB": z.coerce
    .number()
    .min(0)
    .nullable()
    .transform((input: any) => {
  ...
  "cantidad-encuentros-PA": z.coerce
    .number()
    .min(0)
    .nullable()
    .transform((input: any) => {
   ...
   */ "puerta-principal-cantidad": z.coerce
    .number()
    .min(0)
    .nullable()
    .transform((input: any) => {
  ...
  "puerta-ventana-habitacion": z.coerce
    .number()
    .min(0)
    .nullable()
    .transform((input: any) => {
  ...
  "puerta-ventana-living": z.coerce
    .number()
    .min(0)
    .nullable()
    .transform((input: any) => {
